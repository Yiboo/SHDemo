...
#include "../ObjLoader/objload.h"
#include "SH Object/SH_MyObject.h"
...
bool SH_SCENE::Generate(void)
{
	...
	//添加我们的obj模型
	objload::LibObjFile m_objLoader;
	m_objLoader.obj_file_load("model/keting.obj");
	...
	for(int i=0; i<m_objLoader.m_meshes.size(); ++i){
		SH_My_Object* m_object = new SH_My_Object();
		m_object->initObject(m_objLoader.m_meshes[i], colors[i%7]);
